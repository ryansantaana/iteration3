...
public class ProductController implements ActionListener {
	...
	private Adapter dataAdapter; // to save and load product information

	public ProductController(ProductView productView, Adapter dataAdapter) {
	...
	private void saveProduct() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Invalid product tax rate! Please provide a valid product tax rate!");
			return;
		}
